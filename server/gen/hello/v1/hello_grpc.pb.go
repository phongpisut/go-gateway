...
func (c *greeterServiceClient) StreamText(ctx context.Context, in *StreamTextRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamTextResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type GreeterService_StreamTextClient = grpc.ServerStreamingClient[StreamTextResponse]
...
func (UnimplementedGreeterServiceServer) StreamText(*StreamTextRequest, grpc.ServerStreamingServer[StreamTextResponse]) error {
...
func _GreeterService_StreamText_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreeterServiceServer).StreamText(m, &grpc.GenericServerStream[StreamTextRequest, StreamTextResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreeterService_StreamTextServer = grpc.ServerStreamingServer[StreamTextResponse]
