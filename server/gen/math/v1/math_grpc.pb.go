...
const (
	MathService_Add_FullMethodName      = "/math.v1.MathService/Add"
	MathService_Multiply_FullMethodName = "/math.v1.MathService/Multiply"
)
...
var MathService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "math.v1.MathService",
